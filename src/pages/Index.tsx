        ...
        <main className="relative flex-1 bg-brand-lightgray px-8 sm:px-12 py-3 sm:py-4 grid grid-cols-1 sm:grid-cols-[3fr_2fr] gap-4 sm:gap-6 items-center">
          ...
          <div className="relative animate-scale-in overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/25 flex items-center justify-center">
              <p className="font-display font-black uppercase text-center leading-[0.9] text-white text-5xl sm:text-6xl tracking-tight drop-shadow-[0_3px_8px_rgba(0,0,0,0.95)] -rotate-[28deg] w-[150%]">
                Стаканы<br />
                для воды<br />
                <span className="text-brand-yellow text-3xl sm:text-4xl block mt-1">бесплатно!</span>
              </p>
            </div>
          </div>
