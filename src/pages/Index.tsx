...
const benefits = [
  {
    ...
    text: 'При покупке нашего основного ассортимента вы получаете набор стаканов для воды абсолютно бесплатно. Это позволит вам существенно сэкономить средства на начальном этапе открытия вашего проекта.',
  },
  {
    icon: 'PiggyBank',
