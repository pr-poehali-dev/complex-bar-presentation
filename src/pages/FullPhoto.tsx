    ...
    <div className="min-h-screen w-full bg-neutral-300 flex items-center justify-center p-4 sm:p-8 font-sans">
      ...
      <div className="relative w-full max-w-[794px] aspect-[210/297] bg-white text-white overflow-hidden shadow-2xl">
        ...
        <div className="absolute inset-x-0 bottom-[44%] z-10 px-8 sm:px-10 animate-fade-in">
          <h1 className="font-display font-black uppercase leading-[0.95] text-6xl sm:text-7xl tracking-tight text-white drop-shadow-[0_3px_10px_rgba(0,0,0,0.9)] -rotate-[16deg] origin-left">
            Стаканы для воды<br />
